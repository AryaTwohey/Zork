...
public class CommandWords {
  ...
  private static final String validCommands[] = { "go", "move", "quit", "help", "eat", "take", "drop", "search", "read", "run", "shoot", "hit", "stab", "fire", "use", "inventory", "display", "reset", "restart", "space", "fred", "winson", "", "heal"};
